...
class CreateLancheComboDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { nome: { required: true, type: () => String }, descricao: { required: true, type: () => String }, preco: { required: true, type: () => Number } };
    }
}
exports.CreateLancheComboDto = CreateLancheComboDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Combo Popcorn Grande' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateLancheComboDto.prototype, "nome", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Pipoca grande + 2 refrigerantes' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
